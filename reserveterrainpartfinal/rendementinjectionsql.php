...
<section id="sidebar">
		<a href="#" class="brand">
			...
			<span class="text">LinkSport</span>
		</a>
		<ul class="side-menu top">
			<li  >
				<a href="terrainsreserves.php" class="<?php echo basename($_SERVER['SCRIPT_NAME']) == 'terrainsreserves.php' ? 'active' : ''; ?>">
					<i class='bx bxs-calendar-check' ></i>
					<span class="text">Reservation</span>
				</a>
			</li>
			<li >
				<a href="entretien.php" class="<?php echo basename($_SERVER['SCRIPT_NAME']) == 'rendementinjectionsql.php' ? 'active' : ''; ?>">
					<i class='bx bxs-wrench' ></i>
					<span class="text">Entretien</span>
				</a>
			</li>
			<li class="<?php echo basename($_SERVER['SCRIPT_NAME']) == 'rendementinjectionsql.php' ? 'active' : ''; ?>">
                <a href="rendementinjectionsql.php">
                    <i class='bx bxs-doughnut-chart'></i>
                    <span class="text">Rendement</span>
                </a>
            </li>
